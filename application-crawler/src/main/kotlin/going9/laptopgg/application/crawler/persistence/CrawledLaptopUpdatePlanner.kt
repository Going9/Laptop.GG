...
internal class CrawledLaptopUpdatePlanner(
    ...
    fun detailUpdate(
        ...
        return UpdateCrawledLaptopCommand(
            ...
            isSupportsPdCharging = fieldChangePolicy.changedPresent(
                existingLaptop.isSupportsPdCharging,
                command.isSupportsPdCharging,
            ),
            ...
            lastDetailedCrawledAt = fieldChangePolicy.changedPresent(
                existingLaptop.lastDetailedCrawledAt,
                command.lastDetailedCrawledAt,
            ),
